...
const TOOLS = [
  ...
  { name: "Nano Banana Pro", slug: "nano-banana", category: ["art"], minAge: 10, maxAge: 16, pricing: "free", supervision: "hands-on", description: "Google's most advanced AI image generator with stunning photorealism, character consistency, and native text rendering.", link: "/ai-tools/nano-banana" },
  { name: "More Graphics", slug: "more-graphics", category: ["art"], minAge: 6, maxAge: 16, pricing: "free", supervision: "independent", description: "AI-powered platform for generating seamless patterns clipart and graphics with unlimited styles and transparent backgrounds.", link: "/ai-tools/more-graphics" },
  { name: "Playground AI", slug: "playground-ai", category: ["art"], minAge: 13, maxAge: 16, pricing: "free", supervision: "nearby", description: "Free AI image generator offering 50 images per day with multiple AI models, canvas editing, and commercial use rights.", link: "/ai-tools/playground-ai" },
  { name: "Bing Image Creator", slug: "bing-image-creator", category: ["art"], minAge: 13, maxAge: 16, pricing: "free", supervision: "nearby", description: "Microsoft's 100% free AI image generator powered by DALL-E 3 and GPT-4o - no subscription required, just a Microsoft account.", link: "/ai-tools/bing-image-creator" },
  { name: "Freepik AI Image Generator", slug: "freepik-ai-image-generator", category: ["art"], minAge: 13, maxAge: 16, pricing: "free", supervision: "nearby", description: "Professional AI image generator with unlimited creation, multiple AI models, and sketch-to-image tools for design projects.", link: "/ai-tools/freepik-ai-image-generator" },
  { name: "Leonardo AI", slug: "leonardo-ai", category: ["art"], minAge: 13, maxAge: 16, pricing: "free", supervision: "hands-on", description: "Comprehensive AI creative platform for generating high-quality images, videos and visual content with professional tools.", link: "/ai-tools/leonardo-ai", affiliate: true },
  { name: "Midjourney", slug: "midjourney", category: ["art"], minAge: 12, maxAge: 16, pricing: "paid", supervision: "hands-on", description: "Discord-based AI image generator creating stunning artwork from text prompts — the gold standard for AI art quality.", link: "/ai-tools/midjourney" },
  { name: "Quick, Draw!", slug: "quick-draw", category: ["art", "learning"], minAge: 5, maxAge: 12, pricing: "free", supervision: "independent", description: "Google's AI drawing game where kids sketch objects in 20 seconds while a neural network guesses what they're drawing.", link: "/ai-tools/quick-draw" },
  // ── VIDEO GENERATION ──
  { name: "Hedra AI", slug: "hedra-ai", category: ["video", "art"], minAge: 8, maxAge: 16, pricing: "free", supervision: "independent", description: "AI character video creator that transforms static images into expressive talking, singing, and rapping characters.", link: "/ai-tools/hedra-ai" },
  { name: "LeiaPix", slug: "leiapix", category: ["video", "art"], minAge: 6, maxAge: 16, pricing: "free", supervision: "independent", description: "AI-powered 3D image converter that transforms 2D photos into immersive 3D animations using depth mapping technology.", link: "/ai-tools/leiapix" },
  { name: "Pika", slug: "pika", category: ["video"], minAge: 8, maxAge: 16, pricing: "free", supervision: "nearby", description: "AI video generation platform that creates and edits videos from text prompts and images with cinematic quality.", link: "/ai-tools/pika" },
  { name: "Runway", slug: "runway", category: ["video"], minAge: 11, maxAge: 16, pricing: "free", supervision: "nearby", description: "AI-powered video platform that creates high-quality videos from text prompts, images, and video inputs.", link: "/ai-tools/runway" },
  { name: "Kling AI", slug: "kling-ai", category: ["video"], minAge: 12, maxAge: 16, pricing: "free", supervision: "hands-on", description: "Advanced AI video generation platform for professional-grade cinematic video creation from text and images.", link: "/ai-tools/kling-ai" },
  { name: "Synthesia", slug: "synthesia", category: ["video"], minAge: 10, maxAge: 16, pricing: "paid", supervision: "hands-on", description: "AI video platform creating professional videos with realistic AI avatars and voiceovers in 140+ languages.", link: "/ai-tools/synthesia", affiliate: true },
  { name: "Nim Video", slug: "nim-video", category: ["video"], minAge: 10, maxAge: 16, pricing: "paid", supervision: "hands-on", description: "All-in-one AI video app with 25+ leading AI models for professional video creation.", link: "/ai-tools/nim-video", affiliate: true },
  { name: "Higgsfield AI Video Generator", slug: "higgsfield-ai-video-generator", category: ["video"], minAge: 16, maxAge: 16, pricing: "free", supervision: "hands-on", description: "Professional AI video generator with cinematic motion controls, face swap, and lip-sync studio.", link: "/ai-tools/higgsfield-ai-video-generator" },
  // ── MUSIC & AUDIO ──
  { name: "Suno", slug: "suno", category: ["music"], minAge: 8, maxAge: 16, pricing: "free", supervision: "nearby", description: "AI music generator that creates complete songs with vocals and instruments from simple text prompts.", link: "/ai-tools/suno" },
  { name: "Udio", slug: "udio", category: ["music"], minAge: 10, maxAge: 16, pricing: "free", supervision: "nearby", description: "AI music generator creating high-quality songs from text prompts with advanced editing tools and multiple models.", link: "/ai-tools/udio" },
  { name: "ElevenLabs", slug: "elevenlabs", category: ["music", "video"], minAge: 13, maxAge: 16, pricing: "free", supervision: "hands-on", description: "Advanced AI voice generation creating ultra-realistic text-to-speech in 1000s of voices and 32 languages.", link: "/ai-tools/elevenlabs", affiliate: true },
  { name: "Speechace", slug: "speechace", category: ["music", "learning"], minAge: 5, maxAge: 16, pricing: "free", supervision: "independent", description: "Educational speech recognition designed specifically for kids' pronunciation and fluency assessment.", link: "/ai-tools/speechace" },
  // ── WRITING & TEXT ──
  { name: "Grammarly", slug: "grammarly", category: ["writing", "learning"], minAge: 8, maxAge: 16, pricing: "free", supervision: "independent", description: "AI writing assistant for grammar checking, style suggestions, and writing improvement — safe for independent use.", link: "/ai-tools/grammarly" },
  { name: "AI Dungeon", slug: "ai-dungeon", category: ["writing"], minAge: 10, maxAge: 16, pricing: "free", supervision: "hands-on", description: "AI text adventure game with infinite storylines — type actions and watch AI narrate what happens next.", link: "/ai-tools/ai-dungeon" },
  { name: "Character.AI", slug: "character-ai", category: ["writing"], minAge: 13, maxAge: 16, pricing: "free", supervision: "hands-on", description: "Chat with AI versions of fictional characters, historical figures, or custom personalities — popular with teens.", link: "/ai-tools/character-ai" },
  { name: "Claude", slug: "claude", category: ["writing", "learning"], minAge: 10, maxAge: 16, pricing: "free", supervision: "hands-on", description: "Anthropic's AI assistant focused on helpful, harmless conversations for writing, research, and educational support.", link: "/ai-tools/claude" },
  // ── LEARNING & EDUCATION ──
  { name: "Synthesis Tutor", slug: "synthesis-tutor", category: ["learning"], minAge: 8, maxAge: 14, pricing: "paid", supervision: "independent", description: "AI-powered personalised tutoring platform that adapts to individual learning styles and provides real-time help.", link: "/ai-tools/synthesis-tutor", affiliate: true },
  { name: "NotebookLM", slug: "notebooklm", category: ["learning"], minAge: 8, maxAge: 16, pricing: "free", supervision: "nearby", description: "Google's AI research assistant that turns documents into podcasts, study guides, and mind maps — completely free.", link: "/ai-tools/notebooklm" },
  { name: "Mindgrasp AI", slug: "mindgrasp-ai", category: ["learning"], minAge: 8, maxAge: 16, pricing: "free", supervision: "independent", description: "AI learning assistant that creates study materials, summaries, and flashcards from any content.", link: "/ai-tools/mindgrasp-ai" },
  { name: "Quizbot AI", slug: "quizbot-ai", category: ["learning"], minAge: 8, maxAge: 16, pricing: "free", supervision: "nearby", description: "AI quiz generator that creates custom quizzes and tests from any content — makes revision fun.", link: "/ai-tools/quizbot-ai" },
  { name: "Teachable Machine", slug: "teachable-machine", category: ["learning", "coding"], minAge: 8, maxAge: 16, pricing: "free", supervision: "nearby", description: "Google's free tool where kids train their own AI to recognise images, sounds, and poses — no coding needed.", link: "/ai-tools/teachable-machine" },
  { name: "Doctrina AI", slug: "doctrina-ai", category: ["learning"], minAge: 10, maxAge: 16, pricing: "free", supervision: "hands-on", description: "AI education platform for class notes summarisation, essay help, and interactive quizzes for students.", link: "/ai-tools/doctrina-ai" },
  { name: "Gemini Storybook", slug: "gemini-storybook", category: ["learning", "writing"], minAge: 3, maxAge: 10, pricing: "free", supervision: "nearby", description: "Free AI tool creating personalised 10-page illustrated storybooks with read-aloud narration in 45+ languages.", link: "/ai-tools/gemini-storybook" },
  { name: "LittleLit", slug: "littlelit", category: ["learning"], minAge: 4, maxAge: 12, pricing: "free", supervision: "nearby", description: "AI creative learning platform with personalised tutoring, storytelling, art, and STEM projects for kids 4-12.", link: "/ai-tools/littlelit" },
  { name: "Google Gemini", slug: "google-gemini-3-pro", category: ["learning", "coding"], minAge: 13, maxAge: 16, pricing: "free", supervision: "hands-on", description: "Google's most advanced AI for research, coding help, and building interactive learning tools.", link: "/ai-tools/google-gemini-3-pro" },
  // ── CODING ──
  { name: "AI Query", slug: "ai-query", category: ["coding"], minAge: 12, maxAge: 16, pricing: "free", supervision: "hands-on", description: "AI-powered SQL query generator — converts plain English into database queries, making data skills accessible.", link: "/ai-tools/ai-query" },
];
...
function scoreTool(tool, a) {
  ...
  // Interest matching — strongest signal (reward multiple category overlaps)
  const interestMatches = (a.interests || []).filter((i) => tool.category.includes(i)).length;
  s += interestMatches * 20;

  // Derive scores from CMS fields (supervision → safety, category → edu/creativity)
  const safety = tool.supervision === "independent" ? 5 : tool.supervision === "nearby" ? 4 : 3;
  const isEdu = tool.category.some((c) => ["learning", "coding"].includes(c));
  const isCreative = tool.category.some((c) => ["art", "video", "music"].includes(c));
  const education = isEdu ? 5 : tool.category.includes("writing") ? 4 : 3;
  const creativity = isCreative ? 5 : tool.category.includes("writing") ? 4 : 3;

  const p = a.priorities || [];
  if (p.includes("safety")) s += safety * 3;
  if (p.includes("education")) s += education * 3;
  if (p.includes("creative")) s += creativity * 3;
  if (p.includes("cost")) s += tool.pricing === "free" ? 15 : -10;

  // Experience → supervision fit
  const isBeginner = tool.supervision === "independent" || tool.supervision === "nearby";
  if (a.experience === "never" && isBeginner) s += 10;
  if (a.experience === "never" && tool.supervision === "hands-on") s -= 5;
  if (a.experience === "experienced" && tool.supervision === "hands-on") s += 5;
...
// Dynamic why-match text based on category + user goal (replaces per-tool hardcoding)
const WHY_MATCH = {
  art:      { create: "Create stunning AI artwork together — from illustrations to full design projects", learn: "Explore how AI interprets language into visuals and learn prompt engineering", together: "Take turns writing prompts and compare whose imagination creates the best result", confident: "Content-filtered image generation with parental guidance options" },
  video:    { create: "Turn ideas into cinematic video clips your child will want to share", learn: "Understand how AI generates motion, scenes, and visual storytelling", together: "Collaborate on a family short film or animated greeting", confident: "Video creation with content review and parental supervision built in" },
  music:    { create: "Compose original songs, soundtracks, and audio projects from simple text", learn: "Explore music genres and how AI interprets musical concepts", together: "Create family songs, birthday anthems, or silly lullabies together", confident: "Audio creation with lyric review and content filtering available" },
  writing:  { create: "Write stories, build characters, and develop creative projects with AI as co-author", learn: "Develop real writing skills through AI-assisted creative exercises", together: "Collaborate on interactive stories or creative writing challenges as a family", confident: "Text-based tools with content moderation and parental review options" },
  learning: { create: "Turn any topic into engaging study materials, quizzes, and learning tools", learn: "Personalised education that adapts to your child's pace and learning style", together: "Quiz each other and explore new subjects using AI-generated materials", confident: "Education-focused tools designed for safe, independent student use" },
  coding:   { create: "Build real projects — from apps to databases — with AI-assisted coding", learn: "Learn programming and computational thinking with patient AI guidance", together: "Explore how the apps and games they use every day are actually built", confident: "Technical tools with structured learning paths and parental oversight" },
};

function getWhyMatch(tool, goal) {
  const cat = tool.category[0] || "learning";
  const match = WHY_MATCH[cat] || WHY_MATCH.learning;
  return match[goal] || match.create;
}
...
function ToolCard({ tool, answers, index }) {
  ...
  const why = getWhyMatch(tool, goal);
